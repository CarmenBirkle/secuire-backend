...
namespace PWManagerServiceModelEF.Migrations
{
    ...
    [Migration("20230704185800_UserFailedHistoryAndConfiguration")]
    partial class UserFailedHistoryAndConfiguration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PWManagerServiceModelEF.Configuration", b =>
                {
            ...
            modelBuilder.Entity("PWManagerServiceModelEF.UserFailedLoginHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserFailedLoginHistories");
                });
            ...
            modelBuilder.Entity("PWManagerServiceModelEF.UserFailedLoginHistory", b =>
                {
                    b.HasOne("PWManagerServiceModelEF.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
